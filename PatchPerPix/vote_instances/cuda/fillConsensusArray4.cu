...
__device__ void _fillConsensusArray4(
...
__global__ void fillConsensusArray_allPatches4(
    const float inPred[][DATAZSIZE][DATAYSIZE][DATAXSIZE],
    const bool inOverlap[DATAZSIZE][DATAYSIZE][DATAXSIZE],
    float outConsCnt[][NSY][NSX][DATAZSIZE][DATAYSIZE][DATAXSIZE])
{
    ...
    _fillConsensusArray4(idx, idy, idz, inPred, inOverlap, outConsCnt);
    // _fillConsensusArray(idx, idy, idz, inPred, outCons);
}


// device function to set the 3D volume
__global__ void fillConsensusArray_subsetPatches4(
    const float inPred[][DATAZSIZE][DATAYSIZE][DATAXSIZE],
    const bool inOverlap[DATAZSIZE][DATAYSIZE][DATAXSIZE],
    float outConsCnt[][NSY][NSX][DATAZSIZE][DATAYSIZE][DATAXSIZE],
